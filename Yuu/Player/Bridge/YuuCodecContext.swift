...
class YuuCodecContext {
    ...
    var codec: YuuCodec? {
        get {
            if let ptr = cContext.codec {
                return YuuCodec(cCodecPtr: UnsafeMutablePointer(mutating: ptr))
            }
            return nil
        }
    ...
    func openCodec(_ codec: YuuCodec? = nil, options: [String: String]? = nil) throws {
